...
let result;
// 1. user by name exist ?
if (users[0].name) {
    // 2. kalau user ada nama nya, print ini
    result = 'user ada nama nya'
} else {
    // 2. kalau user gak da nama nya, print ini
    result = 'user gak ada nama nya'
}

// 3. print hasil dari pengecheck an
// console.log(result)
